...
namespace GrimHookER::Maps::MapStudio
{
    ...
    class GRIMHOOKER_API Circle final : public Shape
    {
    public:
    ...
    class GRIMHOOKER_API Sphere final : public Shape
    {
    public:
    ...
    class GRIMHOOKER_API Cylinder final : public Shape
    {
    public:
    ...
    class GRIMHOOKER_API Rectangle final : public Shape
    {
    public:
    ...
    class GRIMHOOKER_API Box final : public Shape
    {
    public:
    ...
    /// case by the caller.
    class GRIMHOOKER_API Composite final : public Shape
    {
    public:

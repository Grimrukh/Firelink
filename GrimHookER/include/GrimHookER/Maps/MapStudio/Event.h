...
namespace GrimHookER::Maps::MapStudio
{
    ...
    class GRIMHOOKER_API TreasureEvent final : public Event
    {
    public:
    ...
    class GRIMHOOKER_API SpawnerEvent final : public Event
    {
    public:
    ...
    class GRIMHOOKER_API NavigationEvent final : public Event
    {
    public:
...
NavigationEvent() = default;
    ...
    class GRIMHOOKER_API ObjActEvent final : public Event
    {
    public:
    ...
    class GRIMHOOKER_API NPCInvasionEvent final : public Event
    {
    ...
    class GRIMHOOKER_API PlatoonEvent final : public Event
    {
    public:
    ...
    class GRIMHOOKER_API PatrolRouteEvent final : public Event
    {
    public:
    ...
    class GRIMHOOKER_API MountEvent final : public Event
    {
    public:
    ...
    class GRIMHOOKER_API SignPoolEvent final : public Event
    {
    public:
    ...
    class GRIMHOOKER_API RetryPointEvent final : public Event
    {
    public:

...
namespace GrimHook
{
    ...
    extern template class GRIMHOOK_API GroupBitSet<128>;
    extern template class GRIMHOOK_API GroupBitSet<256>;
    extern template class GRIMHOOK_API GroupBitSet<1024>;
}

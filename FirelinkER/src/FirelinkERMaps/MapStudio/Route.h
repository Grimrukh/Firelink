...
namespace FirelinkER::Maps::MapStudio
{
    ...
    public:
        ...
        explicit Route(const std::u16string& name)
        : Entry(name)
        {
        }
    ...
    class FIRELINK_ER_MAPS_API MufflingPortalLinkRoute final : public Route
    {
    public:
        MufflingPortalLinkRoute() = default;

        explicit MufflingPortalLinkRoute(const std::u16string& name)
        : Route(name)
        {
        }
    ...
    class FIRELINK_ER_MAPS_API MufflingBoxLinkRoute final : public Route
    {
    public:
        MufflingBoxLinkRoute() = default;

        explicit MufflingBoxLinkRoute(const std::u16string& name)
        : Route(name)
        {
        }
    ...
    class FIRELINK_ER_MAPS_API OtherRoute final : public Route
    {
    public:
        OtherRoute() = default;

        explicit OtherRoute(const std::u16string& name)
        : Route(name)
        {
        }

...
namespace Firelink::EldenRing::Maps::MapStudio
{
    ...
    class FIRELINK_ER_MAPS_API EntryParam
    {
    public:
        ...
        public:
            ...
            value_type operator*() { return {*m_keyIt, m_container.at(*m_keyIt)}; }
        ...
        [[nodiscard]] Iterator begin() { return Iterator(m_subtypeOrder.begin(), m_entriesBySubtype); }

        /// @brief End iterator for iterating over all `(subtypeInt, subtypeVector)` pairs in subtype order.
        [[nodiscard]] Iterator end() { return Iterator(m_subtypeOrder.end(), m_entriesBySubtype); }

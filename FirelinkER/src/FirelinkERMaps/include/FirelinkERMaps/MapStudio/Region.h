...
namespace FirelinkER::Maps::MapStudio
{
    ...
    class FIRELINK_ER_MAPS_API Region : public EntityEntry
    {
    public:
        ...
        explicit Region(const std::u16string& name)
        : EntityEntry(name)
        {
        }
        ...
        {
            return m_shape == nullptr ? ShapeType::PointShape : m_shape->GetType();
        }

        /// @brief Set this region's shape to  Creates a new instance of given shape type, which is then returned for
        /// caller modification.
        ...
        {
            return std::format("{}[\"{}\", <{}>]", GetTypeNames().at(GetType()), GetNameUTF8(), GetShapeTypeName());
        }
    ...
    protected:
        ...
        struct CompositeShapeReferences
        {
            ...
            explicit CompositeShapeReferences() { regionIndices.fill(-1); }
    ...
    class FIRELINK_ER_MAPS_API InvasionPointRegion final : public Region
    {
    public:
        ...
        explicit InvasionPointRegion(const std::u16string& name)
        : Region(name)
        {
        }
    ...
    class FIRELINK_ER_MAPS_API EnvironmentMapPointRegion final : public Region
    {
    public:
        ...
        explicit EnvironmentMapPointRegion(const std::u16string& name)
        : Region(name)
        {
        }
    ...
    class FIRELINK_ER_MAPS_API SoundRegion final : public Region
    {
    public:
        ...
        explicit SoundRegion(const std::u16string& name)
        : Region(name)
        {
        ...
        void SetChildRegionAtIndex(const int index, const std::unique_ptr<Region>& region)
        {
            childRegions[index].Set(region);
        }
    ...
    class FIRELINK_ER_MAPS_API VFXRegion final : public Region
    {
    public:
        ...
        explicit VFXRegion(const std::u16string& name)
        : Region(name)
        {
        }
    ...
    class FIRELINK_ER_MAPS_API WindVFXRegion final : public Region
    {
    public:
        ...
        explicit WindVFXRegion(const std::u16string& name)
        : Region(name)
        {
        }
    ...
    class FIRELINK_ER_MAPS_API SpawnPointRegion final : public Region
    {
    public:
        ...
        explicit SpawnPointRegion(const std::u16string& name)
        : Region(name)
        {
        }
    ...
    class FIRELINK_ER_MAPS_API MessageRegion final : public Region
    {
    public:
        ...
        explicit MessageRegion(const std::u16string& name)
        : Region(name)
        {
        }
    ...
    class FIRELINK_ER_MAPS_API EnvironmentMapEffectBoxRegion final : public Region
    {
    public:
        ...
        explicit EnvironmentMapEffectBoxRegion(const std::u16string& name)
        : Region(name)
        {
        }
    ...
    class FIRELINK_ER_MAPS_API WindAreaRegion final : public Region
    {
    public:
        ...
        explicit WindAreaRegion(const std::u16string& name)
        : Region(name)
        {
        }
    ...
    class FIRELINK_ER_MAPS_API ConnectionRegion final : public Region
    {
    public:
        ...
        explicit ConnectionRegion(const std::u16string& name)
        : Region(name)
        {
        }
    ...
    class FIRELINK_ER_MAPS_API PatrolRoute22Region final : public Region
    {
    public:
        ...
        explicit PatrolRoute22Region(const std::u16string& name)
        : Region(name)
        {
        }
    ...
    class FIRELINK_ER_MAPS_API BuddySummonPointRegion final : public Region
    {
    public:
        ...
        explicit BuddySummonPointRegion(const std::u16string& name)
        : Region(name)
        {
        }
    ...
    class FIRELINK_ER_MAPS_API MufflingBoxRegion final : public Region
    {
    public:
        ...
        explicit MufflingBoxRegion(const std::u16string& name)
        : Region(name)
        {
        }
    ...
    class FIRELINK_ER_MAPS_API MufflingPortalRegion final : public Region
    {
    public:
        ...
        explicit MufflingPortalRegion(const std::u16string& name)
        : Region(name)
        {
        }
    ...
    class FIRELINK_ER_MAPS_API OtherSoundRegion final : public Region
    {
    public:
        ...
        explicit OtherSoundRegion(const std::u16string& name)
        : Region(name)
        {
        }
    ...
    class FIRELINK_ER_MAPS_API MufflingPlaneRegion final : public Region
    {
    ...
    public:
        ...
        explicit MufflingPlaneRegion(const std::u16string& name)
        : Region(name)
        {
        }
    ...
    class FIRELINK_ER_MAPS_API PatrolRouteRegion final : public Region
    {
    public:
        ...
        explicit PatrolRouteRegion(const std::u16string& name)
        : Region(name)
        {
        }
    ...
    class FIRELINK_ER_MAPS_API MapPointRegion final : public Region
    {
    public:
        ...
        explicit MapPointRegion(const std::u16string& name)
        : Region(name)
        {
        }
    ...
    class FIRELINK_ER_MAPS_API WeatherOverrideRegion final : public Region
    {
    public:
        ...
        explicit WeatherOverrideRegion(const std::u16string& name)
        : Region(name)
        {
        }
    ...
    class FIRELINK_ER_MAPS_API AutoDrawGroupPointRegion final : public Region
    {
    public:
        ...
        explicit AutoDrawGroupPointRegion(const std::u16string& name)
        : Region(name)
        {
        }
    ...
    class FIRELINK_ER_MAPS_API GroupDefeatRewardRegion final : public Region
    {
    public:
        ...
        explicit GroupDefeatRewardRegion(const std::u16string& name)
        : Region(name)
        {
    ...
    class FIRELINK_ER_MAPS_API MapPointDiscoveryOverrideRegion final : public Region
    {
        // No data at all.
    public:
        ...
        explicit MapPointDiscoveryOverrideRegion(const std::u16string& name)
        : Region(name)
        {
        }
    ...
    class FIRELINK_ER_MAPS_API MapPointParticipationOverrideRegion final : public Region
    {
        // No data at all.
    public:
        ...
        explicit MapPointParticipationOverrideRegion(const std::u16string& name)
        : Region(name)
        {
        }
    ...
    class FIRELINK_ER_MAPS_API HitsetRegion final : public Region
    {
    public:
        ...
        explicit HitsetRegion(const std::u16string& name)
        : Region(name)
        {
        }
    ...
    class FIRELINK_ER_MAPS_API FastTravelRestrictionRegion final : public Region
    {
    public:
        ...
        explicit FastTravelRestrictionRegion(const std::u16string& name)
        : Region(name)
        {
        }
    ...
    class FIRELINK_ER_MAPS_API WeatherCreateAssetPointRegion final : public Region
    {
    public:
        ...
        explicit WeatherCreateAssetPointRegion(const std::u16string& name)
        : Region(name)
        {
        }
    ...
    class FIRELINK_ER_MAPS_API PlayAreaRegion final : public Region
    {
    public:
        ...
        explicit PlayAreaRegion(const std::u16string& name)
        : Region(name)
        {
        }
    ...
    class FIRELINK_ER_MAPS_API EnvironmentMapOutputRegion final : public Region
    {
    public:
        ...
        explicit EnvironmentMapOutputRegion(const std::u16string& name)
        : Region(name)
        {
        }
    ...
    class FIRELINK_ER_MAPS_API MountJumpRegion final : public Region
    {
    public:
        ...
        explicit MountJumpRegion(const std::u16string& name)
        : Region(name)
        {
        }
    ...
    class FIRELINK_ER_MAPS_API DummyRegion final : public Region
    {
    public:
        ...
        explicit DummyRegion(const std::u16string& name)
        : Region(name)
        {
        }
    ...
    class FIRELINK_ER_MAPS_API FallPreventionRemovalRegion final : public Region
    {
    public:
        ...
        explicit FallPreventionRemovalRegion(const std::u16string& name)
        : Region(name)
        {
        }
    ...
    class FIRELINK_ER_MAPS_API NavmeshCuttingRegion final : public Region
    {
    public:
        ...
        explicit NavmeshCuttingRegion(const std::u16string& name)
        : Region(name)
        {
        }
    ...
    class FIRELINK_ER_MAPS_API MapNameOverrideRegion final : public Region
    {
    public:
        ...
        explicit MapNameOverrideRegion(const std::u16string& name)
        : Region(name)
        {
        }
    ...
    class FIRELINK_ER_MAPS_API MountJumpFallRegion final : public Region
    {
    public:
        ...
        explicit MountJumpFallRegion(const std::u16string& name)
        : Region(name)
        {
        }
    ...
    class FIRELINK_ER_MAPS_API HorseRideOverrideRegion final : public Region
    {
    public:
        ...
        explicit HorseRideOverrideRegion(const std::u16string& name)
        : Region(name)
        {
        }
    ...
    class FIRELINK_ER_MAPS_API OtherRegion final : public Region
    {
    public:
        ...
        explicit OtherRegion(const std::u16string& name)
        : Region(name)
        {
        }

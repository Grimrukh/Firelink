...
namespace Firelink::EldenRing::Maps::MapStudio
{
    ...
    class FIRELINK_ER_MAPS_API Event : public Entry
    {
    public:
        ...
        explicit Event(const std::u16string& name)
        : Entry(name)
        {
        }
        ...
        void SetAttachedRegion(const std::unique_ptr<Region>& attachedRegion)
        {
            this->attachedRegion.Set(attachedRegion);
        }
    ...
    public:
        ...
        explicit TreasureEvent(const std::u16string& name)
        : Event(name)
        {
        }
    ...
    public:
        ...
        explicit SpawnerEvent(const std::u16string& name)
        : Event(name)
        {
        ...
        void SetSpawnPartAtIndex(const int index, const std::unique_ptr<Part>& spawnPart)
        {
            spawnParts[index].Set(spawnPart);
        }
        ...
        void SetSpawnRegionAtIndex(const int index, const std::unique_ptr<Region>& spawnRegion)
        {
            spawnRegions[index].Set(spawnRegion);
        }
    ...
    public:
        ...
        explicit NavigationEvent(const std::u16string& name)
        : Event(name)
        {
        }
    ...
    public:
        ...
        explicit ObjActEvent(const std::u16string& name)
        : Event(name)
        {
        }
    ...
    public:
        ...
        explicit NPCInvasionEvent(const std::u16string& name)
        : Event(name)
        {
        }
    ...
    class FIRELINK_ER_MAPS_API PlatoonEvent final : public Event
    {
    public:
        ...
        explicit PlatoonEvent(const std::u16string& name)
        : Event(name)
        {
        ...
        void SetPlatoonPartAtIndex(const int index, const std::unique_ptr<Part>& platoonPart)
        {
            platoonParts[index].Set(platoonPart);
        }
    ...
    public:
        ...
        explicit PatrolRouteEvent(const std::u16string& name)
        : Event(name)
        {
        ...
        void SetPatrolRegionAtIndex(const int index, const std::unique_ptr<Region>& region)
        {
            this->patrolRegions[index].Set(region);
        }
    ...
    public:
        ...
        explicit MountEvent(const std::u16string& name)
        : Event(name)
        {
        }
    ...
    public:
        ...
        explicit SignPoolEvent(const std::u16string& name)
        : Event(name)
        {
        }
    ...
    public:
        ...
        explicit RetryPointEvent(const std::u16string& name)
        : Event(name)
        {
        }
    ...
    public:
        ...
        explicit AreaTeamEvent(const std::u16string& name)
        : Event(name)
        {
        }
    ...
    public:
        ...
        explicit OtherEvent(const std::u16string& name)
        : Event(name)
        {
        }

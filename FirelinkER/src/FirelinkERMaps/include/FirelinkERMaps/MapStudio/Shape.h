...
namespace FirelinkER::Maps::MapStudio
{
    ...
    class FIRELINK_ER_MAPS_API Shape
    {
    public:
    ...
    class FIRELINK_ER_MAPS_API Point final : public Shape
    {
    public:
    ...
    class FIRELINK_ER_MAPS_API Sphere final : public Shape
    {
    public:
    ...
    class FIRELINK_ER_MAPS_API Cylinder final : public Shape
    {
    public:
    ...
    class FIRELINK_ER_MAPS_API Rectangle final : public Shape
    {
    public:
        static constexpr auto Type = ShapeType::RectangleShape;

        Rectangle(const float width, const float depth)
        : m_width(width)
        , m_depth(depth)
        {
        }
    ...
    class FIRELINK_ER_MAPS_API Box final : public Shape
    {
    public:
        static constexpr auto Type = ShapeType::BoxShape;

        Box(const float width, const float depth, const float height)
        : m_width(width)
        , m_depth(depth)
        , m_height(height)
        {
    ...
    /// case by the caller.
    class FIRELINK_ER_MAPS_API Composite final : public Shape
    {
    public:

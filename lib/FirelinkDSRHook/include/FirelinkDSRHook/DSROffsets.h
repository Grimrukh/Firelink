...
namespace Firelink::DarkSouls1R
{
    ...
    namespace SPECIAL_EFFECT
    {
        ...
        // 0x10: some combination of bytes/flags (int); seems to have byte 1 at 0x10 when 40 is active (maybe whenever a
        // non-permanent SpEffect is active?)
    ...
    namespace PLAYER_GAME_DATA
    {
        ...
        inline constexpr int HEAD_ARMOR = 0x344;             // int
        inline constexpr int BODY_ARMOR = 0x348;             // int
        inline constexpr int ARMS_ARMOR = 0x34C;             // int
        inline constexpr int LEGS_ARMOR = 0x350;             // int

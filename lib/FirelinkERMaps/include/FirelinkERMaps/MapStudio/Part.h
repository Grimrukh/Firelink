...
namespace Firelink::EldenRing::Maps::MapStudio
{
    ...
    struct FIRELINK_ER_MAPS_API DrawInfo1
    {
        ...
        void Read(BinaryReadWrite::BufferReader& reader);
    ...
    struct FIRELINK_ER_MAPS_API GParam
    {
        int lightSetId = -1;
        int fogId = -1;
    ...
    struct FIRELINK_ER_MAPS_API SceneGParam
    {
    ...
    struct FIRELINK_ER_MAPS_API GrassConfig
    {
        int unk00 = 0;
        int unk04 = 0;
        int unk08 = 0;
    ...
    struct FIRELINK_ER_MAPS_API UnkPartStruct9
    {
        int unk00 = 0;
    ...
    struct FIRELINK_ER_MAPS_API UnkPartStruct11
    {
        int unk00 = 0;
        int unk04 = 0;
    ...
    public:
        ...
        explicit Part(const std::u16string& name)
        : EntityEntry(name)
        {
        }
        ...
        [[nodiscard]] std::string GetSibPathUTF8() const { return UTF16ToUTF8(m_sibPath); }
        ...
        virtual void SerializeEntryIndices(
            const std::vector<Model*>& models, const std::vector<Part*>& parts, const std::vector<Region*>& regions);
    ...
    protected:
        ...
        void ReadSupertypeData(BinaryReadWrite::BufferReader& reader);
        // Called from inside `SerializeStructs()` override.
        void WriteSupertypeData(BinaryReadWrite::BufferWriter& writer) const;

        // NOTE: All subclasses have subtype data, even if just padding (Map Pieces, Dummy Assets).
        virtual bool DeserializeSubtypeData(BinaryReadWrite::BufferReader& reader) = 0;
        virtual bool SerializeSubtypeData(BinaryReadWrite::BufferWriter& writer, int supertypeIndex, int subtypeIndex) const = 0;

        // Supertype and subtype data structs are also read in here.
        virtual void DeserializeStructs(
            BinaryReadWrite::BufferReader& reader, const PartHeader& header, std::size_t entryStart) = 0;
        virtual void SerializeStructs(
            BinaryReadWrite::BufferWriter& writer,
            PartHeader& header,
    ...
    class FIRELINK_ER_MAPS_API MapPiecePart final : public Part
    {
    public:
        ...
        explicit MapPiecePart(const std::u16string& name)
        : Part(name)
        {
        }
    ...
    private:
        ...
        void DeserializeStructs(
            BinaryReadWrite::BufferReader& reader, const PartHeader& header, std::size_t entryStart) override;
        ...
        bool SerializeSubtypeData(BinaryReadWrite::BufferWriter& writer, int supertypeIndex, int subtypeIndex) const override;
    };
    ...
    public:
        ...
        explicit CharacterPart(const std::u16string& name)
        : Part(name)
        {
        }
        ...
        void SetPatrolRouteEvent(PatrolRouteEvent* const patrolRouteEvent)
        {
            this->patrolRouteEvent.Set(patrolRouteEvent);
        }
        void SetPatrolRouteEvent(const std::unique_ptr<PatrolRouteEvent>& patrolRouteEvent)
        {
            this->patrolRouteEvent.Set(patrolRouteEvent);
        }
        ...
        void SetActivateConditionParamId(const int activateConditionParamId)
        {
            this->activateConditionParamId = activateConditionParamId;
        }
        ...
        void SetBackAwayEventAnimationId(const int backAwayEventAnimationId)
        {
            this->backAwayEventAnimationId = backAwayEventAnimationId;
        }
        ...
        void SetSpecialEffectSetParamIds(const std::array<int, 4>& specialEffectSetParamIds)
        {
            this->specialEffectSetParamIds = specialEffectSetParamIds;
        }
        ...
        void DeserializeEntryReferences(
            const std::vector<Model*>& models,
            const std::vector<Part*>& parts,
            const std::vector<Region*>& regions) override;
        void SerializeEntryIndices(
            const std::vector<Model*>& models,
            const std::vector<Part*>& parts,
            const std::vector<Region*>& regions) override;
    ...
    public:
        ...
        explicit PlayerStartPart(const std::u16string& name)
        : Part(name)
        {
        }
    ...
    class FIRELINK_ER_MAPS_API CollisionPart final : public Part
    {
    protected:
    ...
    public:
        ...
        explicit CollisionPart(const std::u16string& name)
        : Part(name)
        {
        }
    ...
    // settings) is left.
    class FIRELINK_ER_MAPS_API DummyAssetPart final : public Part
    {
        int32_t sUnk18 = -1;
    ...
    public:
        ...
        explicit DummyAssetPart(const std::u16string& name)
        : Part(name)
        {
        }
    ...
    class FIRELINK_ER_MAPS_API DummyCharacterPart final : public CharacterPart
    {
    public:
        ...
        explicit DummyCharacterPart(const std::u16string& name)
        : CharacterPart(name)
        {
        }
    ...
    class FIRELINK_ER_MAPS_API ConnectCollisionPart final : public Part
    {
    protected:
    ...
    public:
        ...
        explicit ConnectCollisionPart(const std::u16string& name)
        : Part(name)
        {
        }
    ...
    struct FIRELINK_ER_MAPS_API ExtraAssetData1
    {
        int16_t unk00 = 0;
        bool unk04 = false;
    ...
    public:
        ...
        explicit AssetPart(const std::u16string& name)
        : Part(name)
        {
        ...
        void SetDrawParentPartAtIndex(const int index, Part* const drawParentPart)
        {
            drawParentParts[index].Set(drawParentPart);
        }
        void SetDrawParentPartAtIndex(const int index, const std::unique_ptr<Part>& drawParentPart)
        {
            drawParentParts[index].Set(drawParentPart);
        }

...
namespace
{
    ...
    std::optional<TPF> load_tpf(const char* name)
    {
...
{
    // Load split binder.
    auto bhd_path = find_resource("c2300.chrtpfbhd");
    auto bdt_path = find_resource("c2300.chrtpfbdt");

...
template <std::size_t BIT_COUNT>
Firelink::GroupBitSet<BIT_COUNT>::GroupBitSet(const std::set<int>& bitSet)
{
    for (int bit : bitSet)
    {
...
template <std::size_t BIT_COUNT>
Firelink::GroupBitSet<BIT_COUNT>::GroupBitSet(const std::vector<uint32_t>& uintList)
{
...
template <std::size_t BIT_COUNT>
Firelink::GroupBitSet<BIT_COUNT> Firelink::GroupBitSet<BIT_COUNT>::FromRange(const int firstBit, const int lastBit)
{
...
// All off
template <std::size_t BIT_COUNT>
Firelink::GroupBitSet<BIT_COUNT> Firelink::GroupBitSet<BIT_COUNT>::AllOff()
{
    return GroupBitSet();
}
...
// All on
template <std::size_t BIT_COUNT>
Firelink::GroupBitSet<BIT_COUNT> Firelink::GroupBitSet<BIT_COUNT>::AllOn()
{
    GroupBitSet result;
    result.bits.set();
    return result;
...
template <std::size_t BIT_COUNT>
std::vector<int> Firelink::GroupBitSet<BIT_COUNT>::ToSortedBitList() const
{
...
template <std::size_t BIT_COUNT>
std::vector<uint32_t> Firelink::GroupBitSet<BIT_COUNT>::ToUintList() const
{
...
// Access bit
template <std::size_t BIT_COUNT>
bool Firelink::GroupBitSet<BIT_COUNT>::operator[](std::size_t index) const
{
...
// Add bit
template <std::size_t BIT_COUNT>
void Firelink::GroupBitSet<BIT_COUNT>::Enable(int index)
{
...
// Remove bit
template <std::size_t BIT_COUNT>
void Firelink::GroupBitSet<BIT_COUNT>::Disable(int index)
{
    if (index < 0 || index >= BIT_COUNT)
    {
        throw std::out_of_range("Bit is out of range for GroupBitSet.");
...
// Intersection
template <std::size_t BIT_COUNT>
Firelink::GroupBitSet<BIT_COUNT> Firelink::GroupBitSet<BIT_COUNT>::Intersection(const GroupBitSet& other) const
{
    GroupBitSet result;
...
// Union
template <std::size_t BIT_COUNT>
Firelink::GroupBitSet<BIT_COUNT> Firelink::GroupBitSet<BIT_COUNT>::UnionWith(const GroupBitSet& other) const
{
    GroupBitSet result;
    result.bits = bits | other.bits;
    return result;
...
// Difference
template <std::size_t BIT_COUNT>
Firelink::GroupBitSet<BIT_COUNT> Firelink::GroupBitSet<BIT_COUNT>::Difference(const GroupBitSet& other) const
{
    GroupBitSet result;
    result.bits = bits & ~other.bits;
    return result;
...
// Equality
template <std::size_t BIT_COUNT>
bool Firelink::GroupBitSet<BIT_COUNT>::operator==(const GroupBitSet& other) const
{

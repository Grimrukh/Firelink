...
namespace Firelink::BinaryReadWrite
{
    ...
    FIRELINK_CORE_API void WriteUTF16String(std::ofstream& stream, const std::streampos& offset, const std::u16string& str);
    ...
    FIRELINK_CORE_API void WriteUTF16String(std::ofstream& stream, const std::streampos& offset, const std::string& str);
